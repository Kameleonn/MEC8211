...
def Generate_sample(seed, filename, mean_d, std_d, poro, nx, dx, plot=False):
    ...
    plot     : bool   - afficher la structure générée
...
if __name__ == "__main__":
    ...
    d_equivalent = Generate_sample(seed, filename, mean_fiber_d, std_d, poro, NX, dx, plot=True)
    
    LBM(filename, NX, deltaP, dx, d_equivalent, plot=True)
